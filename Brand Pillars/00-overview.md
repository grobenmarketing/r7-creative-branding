...
**R7 Creative — Human Touch Marketing in an AI & Automated World**
...
R7 Creative transforms invisible local service businesses into visible, lead-generating machines through our proprietary "You Capture, We Create" system. We manage your digital pulse during the critical **4-minute decision window** when urgent customers decide who to call—ensuring you're one of the 2 businesses that get called instead of one of the 3 that get eliminated in browser tabs.

---

## The Six Brand Pillars

### 1. [[01-brand-positioning|Brand Positioning Statement]]
...
### 2. [[02-unique-value-proposition|Unique Value Proposition]]

**Core System:** "You Capture, We Create" — Digital Pulse Management
...
**→ [[02-unique-value-proposition|Read Full Pillar]]**

---

### 3. [[03-target-market|Target Market Definition]]

**Primary Target:** Local Service Business Owners

**Financial Profile:**
- Revenue: $2-10M annually (sweet spot: $3M)
- Team: 5-20 employees (sweet spot: 8)
- Budget: $550-$950/month available
- Stage: Profitable but plateaued
...
### 4. [[04-problem-solved|Problem Solved Statement]]
...
- **Months 2-3:** 1-2 calls/month → 3-4 calls/week
- **Months 6-12:** Calendar booked 2-3 months out, hire staff

**→ [[04-problem-solved|Read Full Pillar]]**

---

### 5. [[05-customer-avatar|Customer Avatar Summary]]
...
### 6. [[06-messaging-framework|Messaging Framework]]

**Core Message:** "We Keep You in the 4-Minute Decision"
...
- Taglines & headlines that convert

**→ [[06-messaging-framework|Read Full Pillar]]**
...
```
Brand Positioning → defines WHO we are and HOW we're different
        ↓
Unique Value Proposition → explains WHAT we deliver
        ↓
Target Market → identifies WHO we serve
        ↓
Problem Solved → clarifies WHY they need us
        ↓
Customer Avatar → humanizes the target (Marcus)
        ↓
Messaging Framework → operationalizes HOW we communicate
```

**Everything flows from these pillars:**
- Website copy draws from Messaging Framework
- Sales conversations follow Pillar 6 scripts
- Service packages defined in Pillar 2
- Content strategy aligned with Pillar 1 positioning
- Customer journey mapped in Pillar 5

---

## Source Documents

These pillars were built from:
- **[[brand-pillar-interview-transcript|Interview Transcript]]** — 10-question brand strategy interview (primary source)
- **[[brand-pillar-script-summary|Interview Summary]]** — Formatted key insights
- **[[../_reference/The Core Insight-20251101125028|The Core Insight]]** — 4-Minute Decision framework
- **[[../_reference/The 4-Minute Decision_ Complete Market Position-20251101125013|The 4-Minute Decision: Complete Market Position]]**
- **[[../_reference/30 Day Trial-20251101124947|30 Day Trial Agreement]]** — Service packages & trial model
- **[[../_reference/You Capture We Create Workflow-20251101125130|Workflow Documentation]]**

---

## Quick Reference

**Core Positioning:** "We Keep You in the 4-Minute Decision"
**System:** "You Capture, We Create"
...
**Start Here:**
- [[01-brand-positioning|1. Brand Positioning]] → The foundation
- [[06-messaging-framework|6. Messaging Framework]] → Most actionable for daily use

**Team-Specific:**
- Sales: Start with [[06-messaging-framework|Messaging Framework]]
- Marketing: Review [[02-unique-value-proposition|UVP]] and [[06-messaging-framework|Messaging]]
- Operations: See [[../_reference/You Capture We Create Workflow-20251101125130|Workflow Guide]]

[[../INDEX|← Back to Index]] | [[01-brand-positioning|Next: Brand Positioning →]]
